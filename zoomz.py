...
ext = ['.WAV'] # Modify only Zoom file types (WAV)
pref = ['ABMI'] # To deal with Riverforks
...
while True:
    ...
    if (my_file == str("spat")) or (my_file == str("dttm")):
        ...
        spat_list["times"] = spat_list["date"] + " " + spat_list["time"]
...
# # Choose whether to rename the files
# while True:
#    user_rename_choice = input("\nDo you want to rename the files? Y / N? This step is irreversible.\n"
#                               "If you don't want to rename files, select N. The results will be saved in the output csv.")
#    if (user_rename_choice == "Y") or (user_rename_choice == "N"):
#        break
#    else:
#        print('Try again')
#
