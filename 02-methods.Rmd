...
df <- data.frame(
  H2N = c(3, 3, 3, 1, "No"),
  SM4 = c(2, 1, 1, 3, "Yes - with accessories"),
  Mini = c(2, 2, 3, 3, "Yes - with accessories"),
  Micro = c(2, 2, 3, 3, "Yes - with accessories"),
  BAR_LT = c(1, 2, 2, 3, "Yes - built-in"),
  row.names = c("Ease-of-use", "Price", "Weight", "Advanced features", "GPS tracking")
)
