...
kable(df, format = "html", align = "c", row.names = TRUE) %>%
  ...
  footnote(number = c("Autonomous; refers to the ability for the recorder to turn on and off without human interventtion for set periods."))
...
**Please note that this unit will continuously and indiscriminately record and capture all sounds. We kindly request that you use discretion and be mindful of what is being recorded, and respect for your own privacy and the privacy of others.**
:::
