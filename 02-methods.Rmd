...
In order to *digitize* a point count, it must be recorded. This involves selecting appropriate autonomous recording units (**ARUs**) or hand-held recording device that will suit your monitoring program's needs. **Autonomous** refers to the ability for the recorder to turn on and off without human intervention for set periods until the SD cards fill up or the batteries run out.
...
<img align="right" src="images/locations.png" style="float:right;" width="100%"/>
<br>
...
:::{.rmdwarning}
If you're in the field, and the location doesn't have a name, don't panic! As long as the latitude and longitude are given, a name will be provided.
:::
