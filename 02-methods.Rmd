...
df <- data.frame(
  H2N = c("No", "Easy", "$200", "230 g", "Few", "No"),
  SM4 = c("Yes", "Moderate", "$1000", "5400 g", "Many", "Yes - with accessories"),
  Mini = c("Yes", "Moderate", "$600", "290 g", "Many", "Yes - with accessories"),
  Micro = c("Yes", "Moderate", "$300", "195 g", "Many", "Yes - with accessories"),
  BAR_LT = c("Yes", "Difficult", "$1000", "900 g", "Many", "Yes"),
  row.names = c("Autonomous", "Ease-of-use", "Price", "Weight with batteries", "Advanced features", "GPS tracking")
)
